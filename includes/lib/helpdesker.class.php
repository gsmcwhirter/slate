<?php
/**
 * KvScheduler - Helpdesk User Model
 * @package KvScheduler
 ...
 * @subpackage Lib.Models
 */
abstract class Helpdesker extends kvframework_base implements iDBWrapper{
  /**
   * Associated database table
   *
   */
  const Table = "helpdeskers";
  ...
  protected static function do_validations(array $params, $type = "create", $id = null){
    try{
      ...
      if(array_key_exists("username", $params)){
        self::validate_db_uniqueness_of("username",$params["username"],"helpdeskers","username",null,$id,"id");
      }
