 ...
 * @subpackage Lib.Models
 */
abstract class Tag extends kvframework_base implements iDBWrapper{
  /**
  ...
  protected static function do_validations(array $params, $type = "create"){
    try{
      if($type == "create"){
        self::validate_presence_of(array("label","color"), $params);
      }
      if(array_key_exists("color", $params)){
        self::validate_callback_on(array("color"), $params, "callback_hex_color", " is mal-formed.");
      }
